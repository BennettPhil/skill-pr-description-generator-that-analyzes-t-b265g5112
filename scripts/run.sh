...
DEFAULT_TOPIC="A PR description generator that analyzes the diff between two branches and produces a structured pull request description with summary, changes list, testing notes, and review checklist."
DEFAULT_CONTEXT=""
